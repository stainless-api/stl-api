...
export namespace Prisma {
  ...
  */
  ...
  > = S extends { select: any; include: any }
    ...
    ? {
        [P in TruthyKeys<S["select"]>]: P extends keyof PostCountOutputType
          ? PostCountOutputType[P]
          : never;
      }
    : PostCountOutputType;
    ...
    implements Prisma.PrismaPromise<T>
  {
    ...
    comments<T extends User$commentsArgs = {}>(
      args?: Subset<T, User$commentsArgs>
    ): Prisma.PrismaPromise<Array<CommentGetPayload<T>> | Null>;
    ...
    S extends { select: any; include: any }
      ...
      ? Post & {
          [P in TruthyKeys<S["include"]>]: P extends "user"
            ...
            ? Array<CommentGetPayload<S["include"][P]>>
            : P extends "_count"
            ? PostCountOutputTypeGetPayload<S["include"][P]>
            : never;
        }
      ...
      ? {
          [P in TruthyKeys<S["select"]>]: P extends "user"
            ...
            ? Array<CommentGetPayload<S["select"][P]>>
            : P extends "_count"
            ? PostCountOutputTypeGetPayload<S["select"][P]>
    ...
    implements Prisma.PrismaPromise<T>
  {
    ...
    comments<T extends Post$commentsArgs = {}>(
      args?: Subset<T, Post$commentsArgs>
    ): Prisma.PrismaPromise<Array<CommentGetPayload<T>> | Null>;
  ...
  type NotificationCountArgs = Omit<
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__NotificationClient<T, Null = never>
    implements Prisma.PrismaPromise<T>
  {
    private readonly _dmmf;
    private readonly _queryType;
  ...
  export interface NotificationFindUniqueArgs
    extends NotificationFindUniqueArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
     */
  ...
  export interface NotificationFindFirstArgs
    extends NotificationFindFirstArgsBase {
    /**
     * Throw an Error if query returns no results
     * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
     */
