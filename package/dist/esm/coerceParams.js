 ...
 */
export default function coerceParams(schema, { coerceBoolean = defaultCoerceBoolean, coerceString = defaultCoerceString, coerceNumber = defaultCoerceNumber, coerceBigInt = defaultCoerceBigInt, coerceDate = defaultCoerceDate, } = {}) {
