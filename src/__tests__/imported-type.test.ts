...
{
  "/Users/dariusjankauskas/Programming/ts-to-zod/src/__tests__/common.ts": "const Address = z.object({ street: z.string(), city: z.string(), state: z.string(), postalCode: z.string() });
",
