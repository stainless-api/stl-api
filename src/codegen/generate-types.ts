...
function makeActionType(
  ...
  if (config.extensions) {
    ...
    const extensionMutationMethod =
      input !== undefined
        ? dedent`useMutation(opts?: UseMutationOptions): ReactQuery.UseMutationResult<${returnType}, unknown, ${input}>;`
        : dedent`useMutation(opts?: UseMutationOptions): ReactQuery.UseMutationResult<${returnType}, unknown, void>;`;
