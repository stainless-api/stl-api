...
## [0.1.0](https://github.com/stainless-api/stl-api/compare/next-auth-v0.0.2...next-auth-v0.1.0) (2023-07-15)
...
* add metadata to each package.json ([9a9cee9](https://github.com/stainless-api/stl-api/commit/9a9cee9501362c73406fb095d1ff4926c7d61302))
