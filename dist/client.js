...
function createClient(baseUrl) {
    const client = (0, createRecursiveProxy_1.createRecursiveProxy)((opts) => {
        ...
        if ((0, exports.isRequestOptions)(args.at(-1))) {
        ...
        const doFetch = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const parsed = stl_1.z.AnyPageData.safeParse(json);
            if (parsed.success) {
...
class PageImpl {
    ...
    getPreviousPage() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.clientPath
                .reduce((client, path) => client[path], this.client)
