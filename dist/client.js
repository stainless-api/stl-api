...
exports.PaginatorPromise = exports.ClientPromise = exports.PageImpl = exports.createClient = exports.guessRequestEndpoint = void 0;
const qs_1 = __importDefault(require("qs"));
const createRecursiveProxy_js_1 = require("./createRecursiveProxy.js");
const stl_js_1 = require("./stl.js");
const lodash_1 = __importDefault(require("lodash"));
const { isEmpty, once } = lodash_1.default;
...
function createClient(baseUrl, options) {
    ...
    function getMethodAndUri(callPath, action, args) {
        ...
        if (routeMap) {
            ...
            if (match) {
                ...
                return { method: method, pathname, uri };
            }
        }
    ...
    const client = (0, createRecursiveProxy_js_1.createRecursiveProxy)((opts) => {
        ...
        const doFetch = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const parsed = stl_js_1.z.AnyPageData.safeParse(json);
            if (parsed.success) {
