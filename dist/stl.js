...
exports.Stl = exports.OpenAPIResponse = exports.NotFoundError = exports.ForbiddenError = exports.UnauthorizedError = exports.BadRequestError = exports.StlError = exports.isAPIDescription = exports.apiSymbol = exports.allEndpoints = exports.parseEndpoint = exports.getApiRouteMap = exports.PaginatorPromise = exports.ClientPromise = exports.createRecursiveProxy = exports.createClient = exports.z = exports.parseSelect = void 0;
const z = __importStar(require("./z.js"));
exports.z = z;
const openapiSpec_js_1 = require("./openapiSpec.js");
const coerceParams_js_1 = __importDefault(require("./coerceParams.js"));
var parseSelect_js_1 = require("./parseSelect.js");
Object.defineProperty(exports, "parseSelect", { enumerable: true, get: function () { return parseSelect_js_1.parseSelect; } });
var client_js_1 = require("./client.js");
Object.defineProperty(exports, "createClient", { enumerable: true, get: function () { return client_js_1.createClient; } });
var createRecursiveProxy_js_1 = require("./createRecursiveProxy.js");
Object.defineProperty(exports, "createRecursiveProxy", { enumerable: true, get: function () { return createRecursiveProxy_js_1.createRecursiveProxy; } });
var client_js_2 = require("./client.js");
Object.defineProperty(exports, "ClientPromise", { enumerable: true, get: function () { return client_js_2.ClientPromise; } });
Object.defineProperty(exports, "PaginatorPromise", { enumerable: true, get: function () { return client_js_2.PaginatorPromise; } });
var getApiRouteMap_js_1 = require("./gen/getApiRouteMap.js");
Object.defineProperty(exports, "getApiRouteMap", { enumerable: true, get: function () { return getApiRouteMap_js_1.getApiRouteMap; } });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (context.endpoint.query) {
                    (_a = (_d = context.endpoint)[coercedQuery]) !== null && _a !== void 0 ? _a : (_d[coercedQuery] = (0, coerceParams_js_1.default)(context.endpoint.query));
                ...
                if (context.endpoint.path) {
                    (_b = (_e = context.endpoint)[coercedPath]) !== null && _b !== void 0 ? _b : (_e[coercedPath] = (0, coerceParams_js_1.default)(context.endpoint.path));
    ...
    api({ basePath, openapi, topLevel, resources, }) {
        ...
        if (openapiEndpoint !== false) {
            topLevelActions.getOpenapi = this.endpoint({
                ...
                handler() {
                    return __awaiter(this, void 0, void 0, function* () {
                        return (yield (0, openapiSpec_js_1.openapiSpec)(apiDescription));
                    });
                },
            });
        }
