...
class Stl {
    ...
    loadEndpointTypeSchemas(endpoint) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!endpoint.query &&
                ...
                !endpoint.response) {
                if (!this.typeSchemas) {
                    throw new Error("Failed to provide `typeSchemas` to stl instance while using magic schemas");
                }
                try {
    ...
    execute(params, context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                context.parsedParams.query = yield ((_a = context.endpoint.query) === null || _a === void 0 ? void 0 : _a.parseAsync(params.query, parseParams).catch(prependZodPath("<stainless request query>")));
                context.parsedParams.path = yield ((_b = context.endpoint.path) === null || _b === void 0 ? void 0 : _b.parseAsync(params.path, parseParams).catch(prependZodPath("<stainless request path>")));
            ...
            const responseInput = yield context.endpoint.handler(Object.assign(Object.assign(Object.assign({}, body), path), query), context);
            const response = context.endpoint.response
                ? yield context.endpoint.response.parseAsync(responseInput, parseParams)
                : undefined;
            return response;
        });
    }
