...
const getApiRouteMap_js_1 = require("./getApiRouteMap.js");
require("../util/fetch-polyfill.js");
function genApiRouteMap(apiSourceFile) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const key of Object.keys(loaded)) {
            ...
            if ((0, stl_js_1.isAPIDescription)(api)) {
                metadata.push([key, (0, getApiRouteMap_js_1.getApiRouteMap)(api)]);
            }
        }
        if (!metadata.length)
            return;
