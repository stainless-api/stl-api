...
(0, vitest_1.describe)("API Client", () => {
    (0, vitest_1.describe)("single resource", () => {
        ...
        const client = (0, api_client_1.makeClientWithInferredTypes)(config);
        (0, vitest_1.test)("adds methods for each verb", () => {
            ...
            (0, vitest_1.expectTypeOf)(retrieveOutput).toMatchTypeOf();
            (0, vitest_1.expectTypeOf)(updateOutput).toMatchTypeOf();
            (0, vitest_1.expectTypeOf)(retrieveLitterOutput).toMatchTypeOf();
        });
    ...
    (0, vitest_1.describe)("multiple resource", () => {
        ...
        (0, vitest_1.test)("has a methods for sibling resources", () => {
            ...
            (0, vitest_1.expectTypeOf)(dogListOutput).toMatchTypeOf();
        });
        (0, vitest_1.test)("has a methods for sub resources", () => {
            let dogTreatOutput = client
                ...
                .dogTreats("treatId")
                .retrieveTreat();
            (0, vitest_1.expectTypeOf)(dogTreatOutput).toMatchTypeOf();
        });
    });
});
