...
const long_base_path_api_1 = require("../test-util/long-base-path-api");
(0, vitest_1.describe)("API Client", () => {
    ...
    (0, vitest_1.describe)("long base paths", () => {
        let client;
        let mockFetch;
        (0, vitest_1.beforeEach)(() => {
            mockFetch = vitest_1.vi.fn(MockAPI.mockFetchImplementation);
            const config = {
                fetch: mockFetch,
                basePath: long_base_path_api_1.complicatedBasePath,
                urlCase: "camel",
            };
            client = (0, api_client_1.makeClientWithInferredTypes)(config);
        });
        ...
        (0, vitest_1.it)("preserves base path, including casing", () => __awaiter(void 0, void 0, void 0, function* () {
            const dogs = yield client.dogs.list();
            (0, vitest_1.expect)(mockFetch).toHaveBeenCalledWith("/api/camelCase/kebab-case/v2/dogs", {
                method: "GET",
            });
            (0, vitest_1.expect)(dogs).toStrictEqual([{ name: "Fido", color: "red" }]);
        }));
    });
    (0, vitest_1.describe)("fetch calls", () => {
        ...
        (0, vitest_1.it)("can pass query params", () => __awaiter(void 0, void 0, void 0, function* () {
            const cats = yield client.cats.list({ color: "black" });
            (0, vitest_1.expect)(mockFetch).toHaveBeenCalledWith("/api/cats?color=black", {
                method: "GET",
            });
            (0, vitest_1.expect)(cats).toStrictEqual([{ name: "Shiro", color: "black" }]);
        }));
        ...
        (0, vitest_1.it)("handles thrown errors", () => __awaiter(void 0, void 0, void 0, function* () {
            const shouldThrow = client.dogs("fido").update({});
            yield (0, vitest_1.expect)(shouldThrow).rejects.toThrow("Unmocked endpoint: PATCH /api/dogs/fido");
        }));
        (0, vitest_1.it)("handles error responses", () => __awaiter(void 0, void 0, void 0, function* () {
            const shouldThrow = client.dogs("fido!").update({});
            yield (0, vitest_1.expect)(shouldThrow).rejects.toThrow("error message");
        }));
    });
    (0, vitest_1.describe)("`useMethod` style call", () => {
        let client;
        let mockFetch;
        (0, vitest_1.beforeEach)(() => {
