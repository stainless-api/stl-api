...
function makeUrl(callPath, { outputCase, method, body, }) {
...
function makeRequest(config, action, callPath, body) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const url = makeUrl(callPath, { outputCase: config.urlCase, method, body });
    ...
    return new Proxy(proxyClient, {
        ...
        apply(_target, _thisArg, argumentsList) {
            ...
            if (config.extensions) {
                ...
                const queryFn = (callTimeBody) => { var _a; return makeRequest(config, action, path, (_a = callTimeBody !== null && callTimeBody !== void 0 ? callTimeBody : query) !== null && _a !== void 0 ? _a : body); };
                const queryKey = [
