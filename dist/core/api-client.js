        ...
        apply(_target, _thisArg, argumentsList) {
            ...
            if (config.extensions) {
                ...
                const queryFn = (callTimeBody) => {
                    var _a;
                    return makeRequest(config, action, path, (_a = callTimeBody !== null && callTimeBody !== void 0 ? callTimeBody : body) !== null && _a !== void 0 ? _a : bodyOrQuery, body ? bodyOrQuery : undefined);
                };
                const queryKey = [
