...
exports.makeClient = exports.inferHTTPMethod = void 0;
...
function makeUrl(callPath) {
    return callPath.map(strings_1.kebabCase).join("/");
}
/**
    ...
    return new Proxy(proxyClient, {
        ...
        apply(_target, _thisArg, argumentsList) {
            ...
            if (config.extensions) {
                ...
                const handler = (0, extensions_1.getExtensionHandler)(config.extensions, action, queryFn, queryKey);
                return handler === null || handler === void 0 ? void 0 : handler(...argumentsList);
            }
