...
function makeUrl(callPath, { outputCase, method, body, query, }) {
        ...
        apply(_target, _thisArg, argumentsList) {
            ...
            if (config.extensions) {
                ...
                const queryFn = (callTimeBody) => {
                    console.log(action, path, { callTimeBody, query, body });
                    return makeRequest(config, action, path, (callTimeBody !== null && callTimeBody !== void 0 ? callTimeBody : query) ? undefined : body, query);
                };
                const queryKey = [
