 ...
 */
type RequestData<Path extends ZodObjectSchema | undefined, Query extends ZodObjectSchema | undefined, Body extends ZodObjectSchema | undefined> = (Path extends z.ZodTypeAny ? z.infer<Path> : {}) & (Query extends z.ZodTypeAny ? z.infer<Query> : {}) & (Body extends z.ZodTypeAny ? z.infer<Body> : {});
/**
 ...
 * {@link Stl.api} method.
 */
export type APIDescription<BasePath extends HttpPath, TopLevel extends ResourceConfig<AnyActionsConfig, undefined, any>, Resources extends Record<string, AnyResourceConfig> | undefined> = {
    [apiSymbol]: true;
    basePath: BasePath;
...
interface CreateApiOptions<BasePath extends HttpPath, TopLevel extends ResourceConfig<AnyActionsConfig, undefined, any>, Resources extends Record<string, AnyResourceConfig> | undefined> {
    basePath: BasePath;
    /**
...
export declare class Stl<Plugins extends AnyPlugins> {
     ...
     * ```
     */
    api<BasePath extends HttpPath, TopLevel extends ResourceConfig<AnyActionsConfig, undefined, any>, Resources extends Record<string, AnyResourceConfig> | undefined>({ basePath, openapi, topLevel, resources, }: CreateApiOptions<BasePath, TopLevel, Resources>): APIDescription<BasePath, TopLevel & OpenAPITopLevel<typeof openapi>, Resources>;
    /**
     ...
     * ```
     */
    types<T extends Types>(): TypeEndpointBuilder<TypeArgToZodObject<T, "path">, TypeArgToZodObject<T, "query">, TypeArgToZodObject<T, "body">, "response" extends keyof T ? t.toZod<T["response"]> : z.ZodVoid>;
}
type TypeArgToZodObject<T extends Types, K extends keyof Types> = K extends keyof T ? t.toZod<T[K]> extends infer U extends ZodObjectSchema ? U : undefined : undefined;
interface Types {
    path?: object;
    query?: object;
    body?: object;
