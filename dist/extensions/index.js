...
exports.getExtensionHandler = void 0;
const ReactQuery = __importStar(require("./react-query"));
...
function getExtensionHandler(config, action, queryFn, queryKey) {
...
exports.getExtensionHandler = getExtensionHandler;
