...
(0, vitest_1.describe)("react-query extension runtime", () => {
    (0, vitest_1.describe)("useQuery", () => {
        ...
        vitest_1.it.skip("Should send the correct queryFn and queryKey", () => {
        ...
        vitest_1.it.skip("Should allow for query params", () => __awaiter(void 0, void 0, void 0, function* () {
            client.cats.list({ color: "black" }).useQuery();
            (0, vitest_1.expect)(mockUseQuery).toBeCalledWith({
                queryFn: vitest_1.expect.any(Function),
                queryKey: ["/api/cats"],
            });
            (0, vitest_1.expect)(mockFetch).toBeCalledWith("/api/cats?color=black", {
                method: "GET",
            });
        }));
    });
