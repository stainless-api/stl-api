...
export type GetExtensions<Extensions extends ExtensionConfig, Input, _Query, Output> = keyof Extensions extends "reactQuery" ? ReactQuery.MakeExtension<Input, Output> : never;
