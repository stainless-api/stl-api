...
describe("void-returning handlers", () => {
    ...
    test("handler returning void responds with 204", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield app.request("/api/webhooks/events", {
            method: "POST",
        });
        expect(response.status).toBe(204);
        expect(yield response.text()).toBe("");
    }));
    test("handler with explicit bare return responds with 204", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield app.request("/api/webhooks/noop", {
            method: "POST",
        });
        expect(response.status).toBe(204);
        expect(yield response.text()).toBe("");
