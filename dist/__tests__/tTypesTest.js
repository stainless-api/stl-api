...
exports.prismaModel = exports.PathStringSchema = exports.PrismaModelLoader = exports.PrismaModelLoaderSymbol = exports.PrismaModel = exports.PrismaModelSymbol = void 0;
const t = __importStar(require("../t"));
exports.PrismaModelSymbol = Symbol("PrismaModel");
class PrismaModel extends t.EffectlessSchema {
}
exports.PrismaModel = PrismaModel;
exports.PrismaModelLoaderSymbol = Symbol("PrismaModelLoader");
class PrismaModelLoader extends t.Effects {
}
exports.PrismaModelLoader = PrismaModelLoader;
class PathStringSchema extends t.Refine {
    refine(value) {
        return value.startsWith("/");
    }
}
exports.PathStringSchema = PathStringSchema;
