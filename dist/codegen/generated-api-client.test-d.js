...
(0, vitest_1.describe)("Generated API Client", () => {
    ...
    (0, vitest_1.describe)("zod edge cases", () => {
        ...
        (0, vitest_1.test)("can handle native enums", () => {
            (0, vitest_1.expectTypeOf)(client.users("foo").update.useSuspenseQuery({}).data.accountType).toEqualTypeOf();
        });
    });
    (0, vitest_1.describe)("extensions", () => {
        ...
        (0, vitest_1.test)("expects query params", () => {
            (0, vitest_1.expectTypeOf)(client.cats.list.useSuspenseQuery).toBeCallableWith({
                color: "black",
            });
        });
    });
