...
function makeActionType(name, actionPath, api, config) {
    ...
    `;
        const extensionMutationMethod = input !== undefined
            ? (0, dedent_js_1.default) `useMutation(opts?: UseMutationOptions): ReactQuery.UseMutationResult<${returnType}, unknown, ${input}>;`
            : (0, dedent_js_1.default) `useMutation(opts?: UseMutationOptions): ReactQuery.UseMutationResult<${returnType}, unknown, void>;`;
