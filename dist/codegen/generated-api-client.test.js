...
(0, vitest_1.describe)("Generated API Client", () => {
    (0, vitest_1.describe)("configuration options", () => {
        ...
        (0, vitest_1.beforeEach)(() => {
            ...
            client = (0, api_client_1.makeClientWithExplicitTypes)(config);
        });
        ...
        (0, vitest_1.it)("can preserve camel casing", () => __awaiter(void 0, void 0, void 0, function* () {
            const treat = yield client
                ...
                .dogTreats("treatId")
                .retrieveTreat();
            (0, vitest_1.expect)(mockFetch).toHaveBeenCalledWith("/api/dogs/fido/dogTreats/treatId", {
                method: "GET",
            });
    ...
    (0, vitest_1.describe)("react hook calls", () => {
        ...
        (0, vitest_1.it)("can handle overlapping path params at multi-level depth", () => __awaiter(void 0, void 0, void 0, function* () {
            const treat = yield client
                .dogs("fido")
                .dogTreats("treatId")
                .retrieveTreat();
            (0, vitest_1.expect)(mockFetch).toHaveBeenCalledWith("/api/dogs/fido/dog-treats/treatId", {
                method: "GET",
            });
            (0, vitest_1.expect)(treat).toStrictEqual({ yummy: true });
            ...
            (0, vitest_1.expect)(treats).toStrictEqual([{ yummy: true }]);
            ...
            (0, vitest_1.expect)(update).toStrictEqual({ yummy: false });
        }));
    });
});
