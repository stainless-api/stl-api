    ...
    cats: {
        ...
        list: {
            (query?: {
                ...
                useSuspenseQuery(opts?: UseSuspenseQueryOptions): ReactQuery.UseSuspenseQueryResult<{
                    name: string;
                    color: "red" | "blue" | "black" | "white";
                }[]>;
            };
            useMutation(opts?: UseMutationOptions<{
                name: string;
                color: "red" | "blue" | "black" | "white";
            }[], unknown, void>): ReactQuery.UseMutationResult<{
                name: string;
                color: "red" | "blue" | "black" | "white";
            }[], unknown, void>;
            getQueryKey(): string[];
