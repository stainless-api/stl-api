...
```bash
npm i --save stainless-api/stl-api#stainless-0.0.4 stainless-api/stl-api#next-0.0.4

# Optional plugins:
npm i --save stainless-api/stl-api#next-auth-0.0.4  # If you are using next-auth
npm i --save stainless-api/stl-api#prisma-0.0.4     # If you are using Prisma
```
