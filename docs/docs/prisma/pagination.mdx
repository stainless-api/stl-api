...
If your endpoint `response` declares a `t.PrismaModel<>`, you will
...
// declaration attached to it; t.PageResponse inherits
// the prisma model.
type PagePostResponse = t.PageResponse<PostResponse>;
...
We plan to make [`t.PageResponse<>`](/stl/pagination#tpageresponseitem)
